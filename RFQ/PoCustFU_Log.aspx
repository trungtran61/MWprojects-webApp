<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PoCustFU_Log.aspx.cs" Inherits="webApp.RFQ.PoCustFU_Log" %>
...
<body>
  ...
  <aspx:UpdatePanel ID="uPnlLog" runat="server" UpdateMode="Conditional">
   <ContentTemplate>
    ...
    <asp:ObjectDataSource ID="odsResult" runat="server" TypeName="myBiz.DAL.clsPoCustFU" SelectMethod="Result_S">
     <SelectParameters>
  ...
  <aspx:UpdatePanel ID="uPnlViewLog" runat="server" UpdateMode="Conditional">
   <ContentTemplate>
    ...
    <asp:ObjectDataSource ID="odsViewLog" runat="server" TypeName="myBiz.DAL.clsPoCustFU" SelectMethod="FollowUp_Log_S">
     <SelectParameters>
