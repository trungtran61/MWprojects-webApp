<%@ Page Language="C#" MasterPageFile="~/_MasterPage/MasterPage.master" AutoEventWireup="true" Inherits="webApp.Reports.DeptOTD" Title="Department OTD" Codebehind="DeptOTD.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainArea" Runat="Server">
 <table>
  <tr valign="top">
   ...
   <td>
    ...
    <br /><asp:Button ID="btnGo" runat="server" Text="Calculate OTD" CssClass="NavBtn" />
   </td>
  </tr>
 </table>
 <br /><br />
   ...
   <td>
    <aspx:UpdatePanel ID="uPnlOTD" runat="server" UpdateMode="Conditional">
     <ContentTemplate>
      ...
      <telerik:RadChart ID="rChart" runat="server" AutoLayout="true" Height="500px" Width="800px" OnDataBound="chartBound" DataSourceID="odsOTD">
       <ChartTitle><TextBlock Text="Department OTD"></TextBlock></ChartTitle>
       <PlotArea>
        ...
        <XAxis Appearance-MajorGridLines-Visible="false" Appearance-MinorGridLines-Visible="false" Appearance-TextAppearance-TextProperties-Color="Black" DataLabelsColumn="nID" Appearance-LabelAppearance-RotationAngle="300"></XAxis>
       </PlotArea>
      </telerik:RadChart>
     </ContentTemplate>
     <Triggers>
     ...
     <aspx:UpdatePanel ID="uPnlEmail" runat="server" UpdateMode="Conditional">
      <ContentTemplate>
       <table style="background:#CCFFCC;">
        ...
        <tr><td><b>Subject:</b></td><td><asp:TextBox ID="txtSubject" runat="server" Width="300px" Text="Department OTD Graph!"></asp:TextBox></td></tr>
 ...
 <asp:ObjectDataSource ID="odsOTD" runat="server" TypeName="myBiz.DAL.clsReport" SelectMethod="Dept_OTD_S">
  <SelectParameters>
   <asp:Parameter Name="spName" Type="String" DefaultValue="spReport_Dept_OTD_S" />
   ...
   <asp:ControlParameter Name="DeptIDs" Type="String" ControlID="cblDeptList" PropertyName="SelectedValues" />
   <asp:ControlParameter Name="StepIDs" Type="String" ControlID="cblStepList" PropertyName="SelectedValues" />
   <asp:ControlParameter Name="xQueue" Type="String" ControlID="cblQueue" PropertyName="SelectedValues" />
  </SelectParameters>
