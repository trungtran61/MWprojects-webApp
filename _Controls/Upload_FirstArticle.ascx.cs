...
{
    public partial class Upload_FirstArticle : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, "Completed 1st Article Inspection Report", string.Empty, myMode.GrpID, Convert.ToInt32(this.IDs[0]), myMode.gData("mxLN"));
        }
