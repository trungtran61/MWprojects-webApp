...
{
    public partial class ucLAT09 : Common.ucAbstract
    {
        ...
        {
            frmInspection.Update((new clsInspectionReport()).FirstPiece_getData(Request.QueryString["IDs"]));
        }
        protected override void dTask()
        {
            generateForm();
            iMsg.ShowMsg("Thank you! In-process inspection report has been created.", true);
        }
