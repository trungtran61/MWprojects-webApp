...
{
    public partial class Upload_PartPicture : Common.ucAbstract
    {
        ...
        {
            (sender as Button).OnClientClick = string.Format("javascript:loadPreview({0});return false;", this.xID("PartID"));
        }
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Picture of Part", string.Empty, myMode.GrpID, this.xID("PartID"), myMode.gData("mxLN"));
        }
