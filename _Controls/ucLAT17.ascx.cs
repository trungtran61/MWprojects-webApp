...
{
    public partial class ucLAT17 : Common.ucAbstract
    {
        ...
        protected void btn_Click(string cmd)
        {
            ...
            clsFile.Show(Page, pnlPopup, cmd, "Proven Program", string.Empty, myMode.GrpID, TrvlID, myMode.gData("GrpIDs"), LnkIDs, myMode.gData("mxLN"));
        }
