<%@ Control Language="C#" AutoEventWireup="true" Inherits="webApp._Controls.MaterialPO" Codebehind="MaterialPO.ascx.cs" %>
<%@ Register Src="~/_Controls/CurrentMode.ascx" TagName="CurrentMode" TagPrefix="ucMode" %>

<h3>PO FOR MATERIAL</h3>
...
<asp:Panel ID="pnlTask" runat="server" Enabled="false">
 ...
 <asp:GridView ID="gvQuote" runat="server" AutoGenerateColumns="False" DataSourceID="odsQuote" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" DataKeyNames="HID,VendorID" AllowSorting="true">
  ...
  <Columns>
   ...
   <asp:BoundField HeaderText="Quantity" DataField="Quantity" SortExpression="Quantity" InsertVisible="false" />
...
<ucMode:CurrentMode ID="myMode" runat="server" />
   ...
   <tr>
    <td>
     <table cellpadding="0" cellspacing="0" class="Tb2" width="100%">
      ...
      <tr>
       <td>
        Type: <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="true" DataSourceID="odsTypeList" DataValueField="HID" DataTextField="MatlType" OnSelectedIndexChanged="pbKeepOpen" /><br />
        Ams: <asp:DropDownList ID="ddlAms" runat="server" DataSourceID="odsAmsList" DataValueField="HID" DataTextField="MatlAms" /><br />
        Form: <asp:DropDownList ID="ddlForm" runat="server" AutoPostBack="true" DataSourceID="odsFormList" DataValueField="HID" DataTextField="MatlForm" OnSelectedIndexChanged="pbKeepOpen" /><br />
  ...
  <ajax:ModalPopupExtender ID="mpePO" runat="server" TargetControlID="hfHID" PopupControlID="tblPO" BackgroundCssClass="mdlBackground"
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
 <script type="text/javascript">
  ...
  {
   window.radopen("File/Preview.aspx?FID=PO&Code=MaterialPO&HID=" + id, "preview").maximize();
  }
  function doOK()
  {
...
<asp:ObjectDataSource ID="odsQuote" runat="server" TypeName="myBiz.DAL.clsMaterial" SelectMethod="Select_Quotes" InsertMethod="Insert_PO">
 <SelectParameters>
...
<asp:ObjectDataSource ID="odsPO" runat="server" TypeName="myBiz.DAL.clsMaterial" SelectMethod="Distinct_PO">
 ...
 <asp:ObjectDataSource ID="odsRFQPO" runat="server" TypeName="myBiz.DAL.clsMaterial" UpdateMethod="Quote_U1">
  <UpdateParameters>
