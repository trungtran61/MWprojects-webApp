...
{
    public partial class Upload_CompletedTraveler : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Completed Job Traveler", string.Empty, myMode.GrpID, Convert.ToInt32(this.IDs[0]), myMode.gData("mxLN"));
        }
