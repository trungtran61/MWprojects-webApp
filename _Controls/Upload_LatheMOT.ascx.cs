...
{
    public partial class Upload_LatheMOT : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "M.O.T. For Lathe", string.Empty, myMode.GrpID, this.xID("TravelerID"), myMode.gData("mxLN"));
        }
