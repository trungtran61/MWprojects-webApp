...
{
    public partial class Upload_Lathe1stPiece : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, "Completed 1st Piece Inspection Report For Lathe", string.Empty, myMode.GrpID, this.xID("InspectionID"), myMode.gData("mxLN"));
        }
        protected void doView(object sender, EventArgs e)
        {
            clsFile.Show(Page, pnlPopup, "DL", isYN("t05"), "1st Piece & In-Process Inspection Report For Lathe", string.Empty, Convert.ToInt32(myMode.gData("RefID")), this.xID("TravelerID"), string.Empty);
        }
