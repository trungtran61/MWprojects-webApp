...
{
    public partial class Upload_bBluePrint : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Bubbled Blue Print", string.Empty, myMode.GrpID, this.xID("PartID"), myMode.gData("mxLN"));
        }
