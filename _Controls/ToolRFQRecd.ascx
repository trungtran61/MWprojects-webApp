<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ToolRFQRecd.ascx.cs" Inherits="webApp._Controls.ToolRFQRecd" %>
<%@ Register Src="~/_Controls/CurrentMode.ascx" TagName="CurrentMode" TagPrefix="ucMode" %>

<h3>QUOTE FOR TOOL FROM VENDOR(S)</h3>
...
<asp:ObjectDataSource ID="odsQuote" runat="server" TypeName="myBiz.DAL.clsTools" SelectMethod="Select_Quotes" UpdateMethod="Update_Quotes">
 <SelectParameters>
