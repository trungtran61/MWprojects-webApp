...
{
    public partial class Upload_FAIRFIN : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "1st Article & Final Inspection Report", string.Empty, myMode.GrpID, Convert.ToInt32(this.IDs[0]), myMode.gData("mxLN"));
        }
