<%@ Control Language="C#" AutoEventWireup="true" Inherits="webApp._Controls.MaterialRFQ" Codebehind="MaterialRFQ.ascx.cs" %>
<%@ Register Src="~/_Controls/CurrentMode.ascx" TagName="CurrentMode" TagPrefix="ucMode" %>

<h3>RFQ FOR MATERIAL</h3>

Please select the item(s) that you wish to create RFQ for material; then click Submit button to create RFQ for selected item(s).<br /><br />
...
<asp:Panel ID="pnlTask" runat="server" Enabled="false">
   <asp:GridView ID="gvItems" runat="server" AllowPaging="True" PageSize="50" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="HID" DataSourceID="odsItems" ForeColor="#333333" GridLines="None" OnRowDataBound="rwBound">
    ...
    <Columns>
     ...
     <asp:BoundField HeaderText="Quantity" SortExpression="LengthOrdered" DataField="LengthOrdered" />
...
<asp:ObjectDataSource ID="odsItems" runat="server" TypeName="myBiz.DAL.clsMaterial" SelectMethod="Select_Items" InsertMethod="RFQ_Insert">
 <SelectParameters>
