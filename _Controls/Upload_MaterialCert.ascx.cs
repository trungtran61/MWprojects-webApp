...
{
    public partial class Upload_MaterialCert : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Material Certification", string.Empty, myMode.GrpID, Convert.ToInt32(this.IDs[0]), myMode.gData("mxLN"));
        }
