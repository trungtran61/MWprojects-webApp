...
{
    public partial class Upload_MillInProcess : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Completed In-Process Inspection Report For Mill", string.Empty, myMode.GrpID, this.xID("InspectionID"), myMode.gData("mxLN"));
        }
        protected void doView(object sender, EventArgs e)
        {
            clsFile.Show(Page, pnlPopup, "DL", isYN("t05"), "1st Piece & In-Process Inspection Report For Mill", string.Empty, Convert.ToInt32(myMode.gData("RefID")), this.xID("TravelerID"), string.Empty);
        }
