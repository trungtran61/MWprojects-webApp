<%@ Control Language="C#" AutoEventWireup="true" Inherits="webApp._Controls.MaterialRFQRecd" Codebehind="MaterialRFQRecd.ascx.cs" %>
<%@ Register Src="~/_Controls/CurrentMode.ascx" TagName="CurrentMode" TagPrefix="ucMode" %>

<h3>QUOTE FOR MATERIAL FROM VENDOR(S)</h3>
...
<asp:ObjectDataSource ID="odsQuote" runat="server" TypeName="myBiz.DAL.clsMaterial" SelectMethod="Select_Quotes" UpdateMethod="Update_Quotes">
 <SelectParameters>
