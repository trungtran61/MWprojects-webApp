...
{
    public partial class OPSPOSend : ucAbstract
    {
        ...
        protected void poSelected(object sender, EventArgs e)
        {
            ...
            btnPreview.OnClientClick = string.Format("javascript:lPopup('File/Preview.aspx?AppCode={1}&FID=PO&Code=OPSPO&HID={0}&TaskID={2}'); return false;", ddlPO.SelectedValue, this.AppCode, IDs[3]);
        }
