...
{
    public partial class Upload_BluePrint : ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Blue Print", string.Empty, myMode.GrpID, this.xID("PartID"), myMode.gData("mxLN"));
        }
