...
{
    public partial class ucLAT16 : Common.ucAbstract
    {
        ...
        protected void doUpload(object sender, EventArgs e)
        {
            ...
            h.Add("URL", string.Format("http://{0}/{2}/WIP/Misc.aspx?mID={1}&xmlType={3}&xmlFor=Process", Request.ServerVariables["HTTP_HOST"], IDs[3], pi[1], xType));
