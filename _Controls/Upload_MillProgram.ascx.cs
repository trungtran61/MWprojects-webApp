...
{
    public partial class Upload_MillProgram : Common.ucAbstract
    {
        ...
        protected void btn_Click(string cmd)
        {
            ...
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Program For Mill", string.Empty, myMode.GrpID, TrvlID, myMode.gData("GrpIDs"), LnkIDs, myMode.gData("mxLN"));
        }
