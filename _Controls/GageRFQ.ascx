<%@ Control Language="C#" AutoEventWireup="true" Inherits="webApp._Controls.GageRFQ" Codebehind="GageRFQ.ascx.cs" %>
<%@ Register Src="~/_Controls/CurrentMode.ascx" TagName="CurrentMode" TagPrefix="ucMode" %>

<h3>RFQ FOR GAGE(S)</h3>

Please select the item(s) that you wish to create RFQ for gage;<br />then click Submit button to create RFQ for selected item(s).<br /><br />
<asp:Panel ID="pnlTask" runat="server" Enabled="false">
   <asp:GridView ID="gvItems" runat="server" AllowPaging="True" PageSize="50" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="HID" DataSourceID="odsItems" ForeColor="#333333" GridLines="None" OnRowDataBound="rwBound">
    ...
    <Columns>
     ...
     <asp:BoundField HeaderText="Comment" SortExpression="GageDesc" DataField="GageDesc" />
     <asp:BoundField HeaderText="Qty" SortExpression="GageQty" DataField="GageQty" />
    </Columns>
...
<asp:ObjectDataSource ID="odsItems" runat="server" TypeName="myBiz.DAL.clsGage" SelectMethod="Select_Items" InsertMethod="RFQ_Insert">
 <SelectParameters>
