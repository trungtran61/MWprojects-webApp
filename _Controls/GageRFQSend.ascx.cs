...
{
    public partial class GageRFQSend : ucAbstract
    {
        ...
        protected void rfqSelected(object sender, EventArgs e)
        {
            ...
            btnPreview.OnClientClick = string.Format("javascript:lPopup('File/Preview.aspx?AppCode={1}&FID=RFQ&Code=Gage&HID={0}'); return false;", ddlRFQ.SelectedValue, this.AppCode);
        }
