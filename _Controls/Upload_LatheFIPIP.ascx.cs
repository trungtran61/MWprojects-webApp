...
{
    public partial class Upload_LatheFIPIP : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "1st Piece & In-Process Inspection Report For Lathe", string.Empty, myMode.GrpID, this.xID("TravelerID"), myMode.gData("mxLN"));
        }
        protected void viewMOT(object sender, EventArgs e)
        {
            clsFile.Show(Page, pnlPopup, "DL", false, "M.O.T. For Lathe", string.Empty, Convert.ToInt32(myMode.gData("RefID")), this.xID("TravelerID"), string.Empty);
        }
