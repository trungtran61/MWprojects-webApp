...
{
    public partial class Upload_Mill1stPiece : Common.ucAbstract
    {
        ...
        {
            clsFile.Show(Page, pnlPopup, cmd, isYN("t05"), "Completed 1st Piece Inspection Report For Mill", string.Empty, myMode.GrpID, this.xID("InspectionID"), myMode.gData("mxLN"));
        }
