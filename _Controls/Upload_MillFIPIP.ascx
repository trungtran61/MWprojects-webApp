<%@ Control Language="C#" AutoEventWireup="true" Inherits="webApp._Controls.Upload_MillFIPIP" Codebehind="Upload_MillFIPIP.ascx.cs" %>
<%@ Register Src="~/_Controls/CurrentMode.ascx" TagName="CurrentMode" TagPrefix="ucMode" %>

<h3>Upload 1st Piece & In-Process Inspection Report For Mill</h3>
You will be able to upload, edit, view, and print 1st Piece & In-Process Inspection Report for Mill documents from here.<br /><br />
