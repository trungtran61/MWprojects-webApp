...
{
    public partial class GageRFQ : ucAbstract
    {
        ...
        protected void rfqSelected(object sender, EventArgs e)
        {
            ...
            btnPreview.OnClientClick = string.Format("javascript:lPopup('File/Preview.aspx?AppCode={1}&FID=RFQ&GT=GT&Code=Gage&HID={0}'); return false;", ddlRFQ.SelectedValue, this.AppCode);
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (itemIDs.Count() > 0)
            {
                ...
                iMsg.ShowMsg("Thank You! Your RFQ for gage has been created.", true);
            }
        ...
        {
            if ((new clsGage()).RFQ_Delete(ddlRFQ.SelectedValue, this.AppCode))
            {
                ddlRFQ.DataBind();
