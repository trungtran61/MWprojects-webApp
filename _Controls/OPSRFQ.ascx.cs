...
{
    public partial class OPSRFQ : ucAbstract
    {
        ...
        protected void rfqSelected(object sender, EventArgs e)
        {
            ...
            btnPreview.OnClientClick = string.Format("javascript:lPopup('File/Preview.aspx?AppCode={1}&FID=RFQ&Code=OPS&HID={0}&TaskID={2}'); return false;", ddlRFQ.SelectedValue, this.AppCode, IDs[3]);
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (itemIDs.Count() > 0)
            {
                ...
                iMsg.ShowMsg("Thank You! Your RFQ for OPS has been created.", true);
            }
        ...
        {
            if ((new clsOPS()).RFQ_Delete(ddlRFQ.SelectedValue, this.AppCode))
            {
                ddlRFQ.DataBind();
