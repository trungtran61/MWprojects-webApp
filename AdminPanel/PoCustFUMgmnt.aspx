<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPage/MasterPage.master" AutoEventWireup="true" CodeBehind="PoCustFUMgmnt.aspx.cs" Inherits="webApp.AdminPanel.PoCustFUMgmnt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainArea" runat="server">
 <ajax:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
    ...
    <aspx:UpdatePanel ID="uPnlResult" runat="server" UpdateMode="Conditional">
     <ContentTemplate>
      <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true">
       <asp:ListItem Text="Contacting" Value="Contacting"></asp:ListItem>
       <asp:ListItem Text="Confirming" Value="Confirming"></asp:ListItem>
       <asp:ListItem Text="At MW" Value="At MW"></asp:ListItem>
       <asp:ListItem Text="At Customer" Value="At Customer"></asp:ListItem>
      ...
      <asp:ObjectDataSource ID="odsResult" runat="server" TypeName="myBiz.DAL.clsPoCustFU" SelectMethod="Result_S" UpdateMethod="Result_Save">
  ...
  <ajax:TabPanel ID="tabCutOffs" runat="server" HeaderText="Cut-Offs">
   <ContentTemplate>
    <span title="Call to obtain contact information Period">COCIN:</span> <asp:TextBox ID="txtCOCIN" runat="server" Width="100px"></asp:TextBox> hours<br />
    <span title="Call to confirm customer received brochure period">BROC:</span> <asp:TextBox ID="txtBROC" runat="server" Width="100px"></asp:TextBox> days<br />
    <span title="Follow up for VISITING or RFQ period">FoURFQP:</span> <asp:TextBox ID="txtFoURFQP" runat="server" Width="100px"></asp:TextBox> days<br />
  ...
  <ajax:TabPanel ID="tabCustomer" runat="server" HeaderText="P-Customers">
   <ContentTemplate>
    ...
    <asp:ObjectDataSource ID="odsCustomer" runat="server" TypeName="myBiz.DAL.clsPoCustFU" SelectMethod="PoCustFU_ID_S" UpdateMethod="PoCustFU_ID_Save">
     <UpdateParameters>
